...
function deliverDiag(socket,name,container)
{
   ...
   var values =
   {
      today:      [[1,8],[2,7],[3,4],[4,8.4],[5,6],[6,7.5]],
      yesterday:  [[1,5],[2,6],[3,3.9],[4,8.1],[5,5],[6,7.9]],
      one:        [[1,8],[2,7],[3,4],[4,8.4],[5,6],[6,7.5]],
      two:        [[1,5],[2,6],[3,3.9],[4,8.1],[5,5],[6,7.9]],
      three:      [[1,6],[2,6.4],[3,3.7],[4,8.3],[5,5.9],[6,7.9]]
   }
